# List Cleaner | Deduplicate, Sort, Trim & Format Text Lists

> Clean, deduplicate, alphabetize, and format messy text lists online. Strip blank lines, add custom prefixes/suffixes, and sort 100% offline.

[![Live Web App](https://img.shields.io/badge/Web_App-Live_Demo-3B82F6?style=flat-square)](https://cig13zs.github.io/list-cleaner/)
[![Chrome Extension](https://img.shields.io/badge/Chrome_Extension-Manifest_V3-10B981?style=flat-square)](https://github.com/cig13zs/list-cleaner/releases)
...
- **Dual Delivery:** Use directly in your browser at [https://cig13zs.github.io/list-cleaner/](https://cig13zs.github.io/list-cleaner/) or install the offline Chrome Extension package.
...
Paste any raw line-delimited list. The tool trims whitespace, removes duplicate entries, filters empty lines, and sorts items.
...
1. Download or clone this repository:
   ```bash
   git clone https://github.com/cig13zs/list-cleaner.git
   ```
